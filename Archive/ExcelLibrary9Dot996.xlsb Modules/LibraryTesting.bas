...
Public Sub TestStatisticsMovingAverage()
    Debug.Assert EqualQ(MovingAverage(ToDoubles(Range(1, 10)), 2), _
                        Array(1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5, 8.5, 9.5) _
                       )
                        
    Debug.Assert EqualQ(MovingAverage(ToDoubles(Range(1, 10)), 3), _
                        ToDoubles(Range(2, 9)) _
                       )
                       
    Debug.Assert EqualQ(MovingAverage(ToDoubles(Range(1, 10)), 5), _
                        ToDoubles(Range(3, 8)) _
                       )
End Sub
