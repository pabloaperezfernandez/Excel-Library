...
Public Sub HistoricalEtfData3()
    ...
    Let ArrayOfTimeSeries = GetHistorialBloombergData(securities:=securities, _
                                                      fields:=fields, _
                                                      startDate:=#1/1/2018#, _
                                                      endDate:=#12/5/2019# _
                                                     )
    Call DumpInSheet(First(ArrayOfTimeSeries), Sheet1.Range("A1"))
    Call DumpInSheet(Last(ArrayOfTimeSeries), Sheet1.Range("A15"))
End Sub
