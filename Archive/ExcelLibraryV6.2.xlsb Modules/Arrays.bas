...
Public Function ComputeSliceIndices(AnArray As Variant, ParamArray Indices() As Variant) As Variant
...
Private Function ComputeSingleElementIndex(AnArray As Variant, IndicesCopy As Variant) As Variant
    Dim ReturnArray() As Variant
    Dim ni As Variant
    Dim r As Long
    Dim c As Long
...
Private Function ComputeChunkIndices(AnArray As Variant, IndicesCopy As Variant) As Variant
    Dim ReturnArray() As Variant
    Dim ni As Variant
    Dim r As Long
    Dim c As Long
...
Private Function ComputeSpecificElementIndices(AnArray As Variant, IndicesCopy As Variant) As Variant
    Dim ReturnArray() As Variant
    Dim ni As Variant
    Dim r As Long
    Dim c As Long
...
Private Function ComputeSteppedIndices(AnArray As Variant, IndicesCopy As Variant) As Variant
    Dim ni As Variant
...
'        Let IndicesCopy(IndexIndex) = NormalizeIndexArray(AnArray, IndicesCopy(IndexIndex), ir)
...
Private Function PartIntervalIndices(AnArray As Variant, TheIndices As Variant, Optional TheDimension As Long = 1) As Variant
    Dim ni As Variant
