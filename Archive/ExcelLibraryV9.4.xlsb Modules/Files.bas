...
Public Function GetFileNames(ThePath As String, Optional ByVal Attributes As VbFileAttribute = VbFileAttribute.vbNormal) As Variant
    ...
    Let AFileName = Dir(ThePath, Attributes)
