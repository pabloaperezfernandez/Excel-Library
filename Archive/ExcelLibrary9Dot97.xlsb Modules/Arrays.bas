...
Public Function RandomReal(Optional ByVal aRangeOfNumbers As Variant = 1, _
                           ...
                           Optional ParamCheckQ As Boolean = False) As Variant
...
Public Function Sort2DArray(MyArray As Variant, ArrayOfColPos As Variant, _
    ...
    Let Sort2DArray = TempComputation.Range("A1").CurrentRegion.Value2
End Function
...
Public Sub RetoreRangeFormulas(ARange As Range)
    Dim c As Integer
...
Public Sub SaveRangeFormulas(ARange As Range)
    ...
    For c = 1 To HeadersRange.Columns.Count
        ...
        If TheCurrentRegion(2, c).Formula <> vbNullString Then
...
' RETURNED VALUE
' No value is returned
Public Sub RetoreCurrentRegionFormulas()
    Call RetoreRangeFormulas(Selection(1, 1))
End Sub
