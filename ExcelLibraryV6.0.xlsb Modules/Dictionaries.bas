...
Public Function TranslateUsingDictionary(AnAtomicArrayOrTable As Variant, aDict As Dictionary) As Variant
    ...
    If AtomicArrayQ(AnAtomicArrayOrTable) Then
...
Public Function GetValueFromDictionaries(Needles As Variant, _
    ...
    If Not (StringQ(Needles) Or String1DArrayQ(Needles)) Then
