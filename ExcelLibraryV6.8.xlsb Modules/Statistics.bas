...
Function ComputeDistribution(TimeSeries As Variant, NumberOfBins As Integer) As Variant
    ...
    Let BinRightEndPoints = ElementwiseAddition(ElementwiseMultiplication(CreateSequentialArray(1, CLng(NumberOfBins)), _
                                                                          BinSize), _
                                                MinVal)
    ...
    Let ComputeDistribution = ConvertTo1DArray(Application.Frequency(TimeSeries, BinRightEndPoints))
End Function
...
Function ComputeDistributionWithGivenBins(TimeSeries As Variant, BinRightEndPointsArray As Variant)
    Let ComputeDistributionWithGivenBins = ConvertTo1DArray(Application.Frequency(TimeSeries, BinRightEndPointsArray))
End Function
